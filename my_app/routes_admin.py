...
from .helper_role import require_editor_role, require_moderator_role  # Assegura't d'importar el nou permís
...
@login_required
@require_moderator_role.require(http_exception=403)  # Permetre accés a "admin" i "moderator"
def admin_index():
...
@login_required
@require_editor_role.require(http_exception=403)  # Només permetre accés a "admin"
def admin_users():
